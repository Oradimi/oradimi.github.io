...
import ComicsItem from "./pages/ComicsItem.vue";
import FanartItem from "./pages/FanartItem.vue";
import i18n from "./i18n";

const routes = [
  { path: "/", component: HomeItem },
  { path: "/art", component: ArtItem },
  { path: "/comics", component: ComicsItem },
  { path: "/fanart", component: FanartItem },
